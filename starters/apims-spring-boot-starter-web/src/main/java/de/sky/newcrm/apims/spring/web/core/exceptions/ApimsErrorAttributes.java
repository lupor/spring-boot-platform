...
import de.sky.newcrm.apims.spring.exceptions.ApimsDetailsAwareException;
import de.sky.newcrm.apims.spring.exceptions.ApimsNotAuthorizedException;
...
public class ApimsErrorAttributes {
    ...
    public boolean resolveErrorAttributes(
        ...
        if (exception instanceof InvalidResponseDataBusinessException) {
            ...
            logStacktrace = true;
        } else if (exception instanceof de.sky.newcrm.apims.spring.exceptions.ApimsBaseException) {
            processCommonErrorAttributes(request, httpStatus, exception, errorAttributes);
    ...
    protected void processCommonErrorAttributes(
            ...
            Throwable exception,
            Map<String, Object> errorAttributes) {
        de.sky.newcrm.apims.spring.exceptions.ApimsBaseException bex = exception instanceof de.sky.newcrm.apims.spring.exceptions.ApimsBaseException abe ? abe : null;
        ...
        if (!StringUtils.hasLength(errorCode)) {
            errorCode = de.sky.newcrm.apims.spring.exceptions.BusinessExceptionErrorCodes.calculateErrorCode(exception, false);
        }
    ...
    protected List<String> createBusinessExceptionHierarchy(Class<?> clazz) {
        ...
        while (Object.class != searchType && searchType != null) {
            ...
            if (searchType.getName().equals(de.sky.newcrm.apims.spring.exceptions.BusinessException.class.getName())) {
                break;
            }
