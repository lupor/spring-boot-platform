...
public class ApimsJsonMapper {

    protected static final JsonMapper DEFAULT_OBJECT_MAPPER_JSON =
            DefaultJacksonObjectFactory.createDefaultJsonObjectMapper();

    protected final ObjectMapper objectMapper;

    protected ApimsJsonMapper() {
        this.objectMapper = DEFAULT_OBJECT_MAPPER_JSON;
    }
