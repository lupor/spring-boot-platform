...
public abstract class DefaultJacksonObjectFactory {
    ...
    public static JsonMapper.Builder createDefaultJsonMapperBuilder() {
        return customizeJsonMapperBuilder(JsonMapper.builder());
    }

    public static JsonMapper.Builder customizeJsonMapperBuilder(JsonMapper.Builder builder) {
        return builder.defaultPrettyPrinter(createDefaultJsonPrettyPrinter())
