 ...
 */
package de.sky.newcrm.apims.spring.telemetry.mdc.core;
...
public class ApimsMdc implements InitializingBean {
    ...
    public Map<String, String> getApimsMap() {
    ...
    public boolean isApimsMdcKey(String key) {
        return StringUtils.hasLength(mdcPrefix) && key.startsWith(mdcPrefix);
    }

    public String calculateApimsMdcKey(String key, boolean globalField) {
